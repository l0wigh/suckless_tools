...
Popout {
    ...
    component TransportButton: Item {
        id: tbRoot
        property alias text: tbIcon.text
        property alias iconSize: tbIcon.font.pixelSize
        ...
        Rectangle {
            ...
            radius: width / 2
            color: isPrimary
                ? (tbMa.containsMouse ? Qt.alpha(Theme.accent, 0.22) : Qt.alpha(Theme.fg, 0.08))
                : (tbMa.containsMouse ? Qt.alpha(Theme.fg, 0.1) : "transparent")
        ...
        Text {
            ...
            font.pixelSize: 18
            color: tbRoot.allowed
                ? (tbRoot.isPrimary ? Theme.accent : (tbMa.containsMouse ? Theme.accent : Qt.alpha(Theme.fg, 0.85)))
        ...
        MouseArea {
            ...
            anchors.fill: parent
            hoverEnabled: true
            cursorShape: tbRoot.allowed ? Qt.PointingHandCursor : Qt.ArrowCursor
            onClicked: if (tbRoot.allowed) tbRoot.tapped()
        }
    }
