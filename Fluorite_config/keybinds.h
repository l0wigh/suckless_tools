...
static void fluorite_dmenu() { char prog[255] = "dmenu_run -x 10 -y 4 -z 1419 -nb '#282c34'"; fluorite_execute(prog, GUI); }
static void fluorite_webbrowser() { char prog[255] = "tabbed surf -e"; fluorite_execute(prog, GUI); }
...
static void fluorite_brightness_up() { char prog[255] = "/root/tools/scripts/brightness.sh up"; fluorite_execute(prog, NOGUI); }
static void fluorite_brightness_down() { char prog[255] = "/root/tools/scripts/brightness.sh down"; fluorite_execute(prog, NOGUI); }
